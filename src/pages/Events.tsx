...
const upcomingEvents = [
  {
    ...
    location: "SportElite Main Stadium",
    category: "Tournament",
    image: gallery1,
    description: "Annual football championship featuring top academies from across the region",
    spots: "32 Teams",
  },
  {
    ...
    location: "SportElite Indoor Arena",
    category: "Training Camp",
    image: gallery2,
    description: "Intensive two-week basketball training camp for aspiring players",
    spots: "60 Spots",
  },
  {
    ...
    location: "SportElite Fitness Center",
    category: "Competition",
    image: gallery3,
    description: "Test your limits in our annual fitness challenge event",
    spots: "150 Spots",
  },
  {
    ...
    category: "Tournament",
    image: gallery4,
    description: "Season finale of the SportElite Cricket League",
    spots: "8 Teams",
  },
];
