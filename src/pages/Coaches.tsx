...
const coaches = [
  {
    ...
    image: coach1,
    experience: "15+ years",
    specialization: "Technical Skills & Tactics",
    certifications: ["UEFA Pro License", "FIFA Instructor"],
    achievements: ["Former National Team Player", "3x Championship Winner"],
    bio: "David brings over 15 years of professional football experience. His unique coaching methodology has produced multiple national-level players.",
  },
  {
    name: "Sarah Thompson",
    role: "Fitness & Performance Director",
    image: coach2,
    experience: "12+ years",
    specialization: "Strength & Conditioning",
    certifications: ["CSCS Certified", "Sports Nutrition Expert"],
    achievements: ["Olympic Team Trainer", "Published Sports Scientist"],
    bio: "Sarah specializes in performance optimization and injury prevention. Her scientific approach has helped hundreds of athletes reach peak performance.",
  },
  {
    name: "James Anderson",
    ...
    certifications: ["FIBA Level 3", "Youth Development Specialist"],
    achievements: ["Former Pro Player", "State Championship Coach"],
    bio: "James combines his professional playing experience with innovative coaching techniques to develop well-rounded basketball players.",
  },
  {
    ...
    image: coach1,
    experience: "18+ years",
    specialization: "Batting & Bowling",
    certifications: ["ICC Level 3", "Sports Psychology"],
    achievements: ["International Cricketer", "Academy Graduate Mentor"],
    bio: "Michael's extensive international experience and passion for developing young talent makes him an invaluable asset to our cricket program.",
  },
  {
    name: "Emily Chen",
    role: "Swimming Coach",
