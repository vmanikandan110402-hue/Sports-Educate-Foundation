...
const programs = [
  {
    ...
    duration: "12 months",
    description: "Comprehensive football training covering technique, tactics, and match play",
    features: ["Technical skills", "Tactical awareness", "Match preparation", "Fitness conditioning"],
  },
  {
    ...
    level: "All Levels",
    duration: "10 months",
    description: "Develop your basketball skills with our expert coaching program",
    features: ["Ball handling", "Shooting mechanics", "Defense strategies", "Team play"],
  },
  {
  ...
  },
  {
    ...
    duration: "12 months",
    description: "Master batting, bowling, and fielding with professional cricket coaching",
    features: ["Batting technique", "Bowling variations", "Fielding drills", "Match simulation"],
  },
  {
